...
public class C03_DataProviderParalelTseting {
    /*
...
*/
    ...
    @DataProvider (parallel = true) // (parallel = true) sadece burayı yazdık ve run yaptık.+ pencere açtı ve aynı anda test etti
